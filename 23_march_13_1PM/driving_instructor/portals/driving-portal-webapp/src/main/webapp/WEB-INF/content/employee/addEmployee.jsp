...
<body>
	<content tag="breadcrum">
		...
		<li> &gt; </li>	
		<li><a href="#" class="disable"><s:message code="layout.breadcrum.addEmployeeDetails" /></a></li>
	</content>	
...
<article class="mainArticle">
  <div class="container"> 
    ...
    <section class="manageEmployee">
     <form:form method="POST" action="${pageContext.request.contextPath}/employees/add" id="employeeForm" modelAttribute="employeeDetail" class="form-horizontal">
                  ...
                  <div class="editDetailsBox">
                    ...
                    <div class="control-group">
                      <div class="pull-left">
                        ...
                        <form:input path="employee.dob" id="dob" readOnly="true" class="input-medium dob marginR10" maxlength="15" />
                    ...
                    <div class="control-group">
                      ...
                      <div class="pull-right inline-form">
                        ...
                        <div class="pull-left">
                            ...
                            <label class="checkbox inline label-emp" for="employment_type_FT">Full Time</label>
                      	</div>
                        <div class="pull-left">
                        	<form:radiobutton path="employee.employmentType" id="employment_type_PT" value="FULL_TIME"/>
                            <label class="checkbox inline label-emp" for="employment_type_PT">Part Time</label>
                      	</div>
                        <div class="pull-left">
